...
#define HA_MAX_SESSION_ATTRS_LEN 300
...
enum HA_ERR_CODE {
  ...
  HA_ERR_SYS,
  HA_ERR_EXCEPTION,
  HA_ERR_INVALID_PARAMETER,
  HA_ERR_INVALID_USER,
  HA_ERR_RAND_STR_TOO_LONG,
  HA_ERR_GET_INST_ID,
  HA_ERR_WRITE_INST_ID,
  HA_ERR_GET_LOCAL_IP,
  HA_ERR_EXPLICIT_DEF_TIMESTAMP_INCONSIST,
  HA_ERR_DECRYPT_PASSWORD,
  HA_ERR_CREATE_INST_GROUP_USER,
  HA_ERR_NO_AVAILABLE_DUMP_SRC,
  HA_ERR_DUMP_METADATA,
  HA_ERR_RECOVER_METADATA,
  HA_ERR_FIX_CREATE_TABLE,
  HA_ERR_HA_INIT,
  HA_ERR_WAIT_TIMEOUT,
  HA_ERR_ABORT_BY_USER
};
#endif
