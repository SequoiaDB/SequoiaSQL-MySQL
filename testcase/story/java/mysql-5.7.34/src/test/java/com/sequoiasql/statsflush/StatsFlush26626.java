...
/**
 * @Description seqDB-26626:表数据量小于1000w，数据累计变化量阈值测试
 * @Author xiaozhenfan
 * @Date 2022.07.05
 * @UpdateAuthor xiaozhenfan
 * @UpdateDate 2022.07.05
 */
public class StatsFlush26626 extends MysqlTestBase {
    private String dbName = "db_26626";
    ...
    public void test() throws Exception {
        ...
        // 其中一个实例做delete、insert混合操作，操作累计变化的数据量小于50
        ...
        // 累计变化的数据量大于50，查看实例2中查询表tbName1的访问计划跟实例1的相同
