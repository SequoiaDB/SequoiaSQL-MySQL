...
/**
 * @Description seqDB-26629:表数据量大于等于1000w，数据累计变化量未达到数据量10%但是大于50w
 * @Author xiaozhenfan
 * @Date 2022.07.05
 * @UpdateAuthor xiaozhenfan
 * @UpdateDate 2022.07.05
 */
public class StatsFlush26629 extends MysqlTestBase {
    private String dbName = "db_26629";
    ...
    public void test() throws Exception {
        ...
        // 插入数据，数据量大于1000w，如：1000w+1（debug包设置为1000）；
        ...
        // 操作累计变化的数据量覆盖未达到数据量10%但是大于50w（debug包设置为50）；
        // 变化的数据量小于50，查看实例2中查询表tbName1的访问计划仍然不变
        jdbc1.update( "set debug=\"d,stats_flush_percent_test\";" );
